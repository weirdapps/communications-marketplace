...
### basics/ (30 icons)
General UI and interaction icons.
...
| `Info.png` | Information, help tooltips, guidance |
| `Layers.png` | Multiple layers, stacked products, complexity |
| `Loop.png` | Recurring, subscription, repeat |
...
### documents/ (35 icons)
Documents, IDs, contracts, and records.
...
### devices/ (26 icons)
Cards, phones, computers, and banking terminals.
...
### security/ (25 icons)
Authentication, protection, and fraud prevention.
...
### media/ (29 icons)
Digital media, browsers, printing, and scanning.
...
### people/ (19 icons)
Users, customers, groups, and personas.
...
### system/ (16 icons)
Settings, configuration, and system operations.
...
### hands/ (12 icons)
Touch, gestures, and card interactions.
...
| `Building.png` | Commercial building, office |
| `Forest.png` | Nature, green, environmental |
| `Home.png` | Home, residential property |
| `House.png` | House, mortgage |
| `Keys.png` | Keys, property ownership |
...
### life-stages/ (10 icons)
Personal milestones and achievements.

| Filename | Use when |
|----------|----------|
| `Crown.png` | Premium, VIP, top tier |
| `Diamond.png` | Premium product, luxury |
| `Educatio.png` | Education, student loan |
| `Health.png` | Health, medical |
| `Heatrbeat.png` | Heartbeat, vitality, health monitoring |
| `Idea.png` | Idea, innovation, insight |
| `Married.png` | Marriage, family milestone |
| `Medal.png` | Achievement, award |
| `Trophy.png` | Winner, top performance |
| `Winner.png` | Winner, best, first place |
...
### entertainment/ (5 icons)
Leisure and lifestyle.

| Filename | Use when |
|----------|----------|
| `Coffee.png` | Lifestyle, daily spending, coffee |
...
| Filename | Use when |
|----------|----------|
| `Covid.png` | Health crisis, pandemic context |
| `Flag.png` | Flag, milestone, goal |
| `Mountain.png` | Challenge, summit, goal |
| `Tree.png` | Sustainability, green, environment |
...
| Filename | Use when |
|----------|----------|
| `Snow.png` | Winter, cold |
| `Sun.png` | Bright, positive, clear |
| `Thunder.png` | Storm, risk, disruption |
| `Umbrella.png` | Insurance, protection |
| `Waterr.png` | Water, flood, liquid |
